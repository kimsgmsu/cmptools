...
"""
Transform3d: library for 3d transformation
"""

def find_affine_transformation(anchor0, anchor1):

    """
    Find a affine transformation matrix that transforms 
    anchor1 (tetrahedron) to anchor2 tetrahedron.
    """
    primary = anchor0.vertex
    secondary = anchor1.vertex
    ...
    print('Transform3d: Transformation matrix:')
    print(A)
